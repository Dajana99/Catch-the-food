...
class ScoreBoard():
    ...
    def gameOver(self):
        self.saveScore()
        tkinter.messagebox.showinfo("Kraj igre","Izgubio si!")        
        if tkinter.messagebox.askyesno(" Kraj igre", "Igraj ponovo?"):
            self.reset()
        else:
            exit()
...
class ItemsFalling():
    ...
    def __init__(self,parent,canvas,player,board):
        ...
        self.fallSpeed = 75                            
        self.xPosition = randint(50, 700)       
        self.isgood = randint(0, 1)             
        
        self.goodItems = ["ananas.gif","apple.gif","orange.gif"]
        self.badItems = ["candy1.gif","candy2.gif","lollypop.gif","burger.png"]
...
class TheGame(ItemsFalling,ScoreBoard):
    ...
    def createEnemies(self):
        ItemsFalling(self.parent, self.canvas, self.playerChar, self.personalboard)
